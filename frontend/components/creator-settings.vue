  ...
  <div class="md:px-8 container">
    ...
    <div v-show="currentTab === 'account'">
      ...
      <fm-form class="max-w-md mx-auto lg:mx-0" :errors="notificationErrors" @submit.prevent="handleNotificationSubmit">
        ...
        <fm-input v-model="form.notification.notify_post_comments" class="!mt-2" type="checkbox">Comments on my posts and tips</fm-input>
    ...
    <div v-show="currentTab === 'discord'">
      ...
      <div class="text-xl font-medium text-black flex items-center">Discord User</div>
      <div class="text-gray-500 mt-2 text-sm mt-4 max-w-xl">
...
import { skipOnboarding, maskString, handleGenericError } from '~/utils';
...
export default {
  ...
  computed: {
    ...mapState('users', ['accounts', 'integrations']),
    hasUnsavedChanges() {
      return {
  ...
  methods: {
    ...mapActions('users', ['loadAccounts', 'updateSelfUser', 'updatePassword', 'loadIntegrations']),

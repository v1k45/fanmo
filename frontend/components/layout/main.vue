...
<div>
  ...
  <header class="sticky top-0 z-10 py-2 bg-white shadow-sm">
    <div class="container flex items-center">
      <div v-if="1 || false" class="inline-block text-xl font-bold">
      ...
      <nav>
        ...
        <ul :class="{
          ...
          <li><nuxt-link to="/pricing#comparison">Comparison</nuxt-link></li>
          <li><nuxt-link to="/login">Login</nuxt-link></li>
          <li>
            <nuxt-link
              to="/signup"
              class="inline-block px-8 py-3 transition-colors rounded-full bg-fm-primary-100 hover:bg-fm-primary-500 hover:text-white">
              Sign up
            </nuxt-link>
          </li>
        </ul>
  ...
  <!-- footer start -->
  <footer class="py-12 md:py-24 bg-white">
    <div class="container">
      <div class="flex items-center">
        ...
        <div class="flex text-black">
          <a href="#" title="Facebook" class="p-2 rounded-lg hover:bg-blue-500 hover:text-white transition-colors">
            <icon-facebook></icon-facebook>
            <span class="sr-only">Facebook</span>
          </a>
          <a href="#" title="Twitter" class="p-2 rounded-lg ml-4 hover:bg-sky-500 hover:text-white transition-colors">
            <icon-twitter></icon-twitter>
            <span class="sr-only">Twitter</span>
          </a>
          <a href="#" title="Instagram" class="p-2 rounded-lg ml-4 hover:bg-violet-500 hover:text-white transition-colors">
      ...
      <div class="flex flex-wrap items-center mt-2 lg:mt-12">
        ...
        <div class="mt-8 lg:mt-0 flex flex-wrap text-black text-sm md:text-base justify-center">
          <nuxt-link class="py-2 mr-4 hover:text-fm-primary" to="/pricing#faq">FAQ</nuxt-link>
          <a class="p-2 mr-2 hover:text-fm-primary" href="#">Terms &amp; Conditions</a>
          <a class="p-2 mr-2 hover:text-fm-primary" href="#">Privacy Policy</a>
          <a class="p-2 hover:text-fm-primary" href="#">Cancellation policy</a>
        </div>
      </div>
    </div>
  </footer>

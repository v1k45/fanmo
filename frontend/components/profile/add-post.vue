                  ...
                  <div class="flex items-center">
                    <div class="flex flex-wrap flex-grow mr-auto">
                      <div class="w-full basis-auto unstyled" title="Open post">
                        <div class="text-lg md:text-xl text-black font-bold w-full">{{ form.title || "Title" }}</div>
                      </div>
                    </div>
                  </div>
                ...
                <template v-if="form.content">
                  ...
                  <div v-if="contentType === 'link' && form.content.link" class="post-body">
                    ...
                    <div
                      ...
                      <fm-button type="info" :loading="loading"><icon-refresh-cw class="h-em w-em" @click.prevent="getPreview"></icon-refresh-cw> Load preview</fm-button>
                    </div>
